...
class EditOrAddNewContributor extends React.Component {
  constructor(props) {
    super(props);
    this.INITIAL_STATE = {
  ...
  async fetchDefault() {
    ...
    try {
      ...
      const role = find(roles, { name: 'author' });
  ...
  async handleSubmit(e) {
    ...
    validateFields(async (errors, value) => {
      ...
      try {
        ...
        dispatch(push('/users/all-contributors'));
      } catch (e) {
    ...
    return (
      <div>
        <div className="utils__title utils__title--flat mb-3">
          <strong>
            {isEmpty(userId) ? 'Add New Contributor or Author' : 'Edit Contributor or Author'}
          </strong>
        </div>
...
export default Form.create()(EditOrAddNewContributor);
